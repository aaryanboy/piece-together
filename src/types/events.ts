...
export interface ServerToClientEvents {
  ...
  pieces_snapped: (data: { anchorPieceId: number; pieceIds: number[]; targetX: number; targetY: number; groupId: number; isPlaced: boolean; progressPercent: number; pieces?: PuzzlePieceData[] }) => void;
  ...
  snap_rejected: (data: { pieceIds: number[]; reason: 'not-correct-spot' | 'not-neighbors'; pieces: PuzzlePieceData[] }) => void;
